...
(function() {
  ...
  MT("vanillaLink",
     "foo [link http://www.huiketong.com/] bar");

  MT("vanillaLinkPunctuation",
     "foo [link http://www.huiketong.com/]. bar");

  MT("vanillaLinkExtension",
     "foo [link http://www.huiketong.com/index.html] bar");

  MT("vanillaLinkEmphasis",
     "foo [em *][em&link http://www.huiketong.com/index.html][em *] bar");

  MT("notALink",
     "[comment ```css]",
     "[tag foo] {[property color]:[keyword black];}",
     "[comment ```][link http://www.huiketong.com/]");

  MT("notALink",
     "[comment ``foo `bar` http://www.huiketong.com/``] hello");

  MT("notALink",
     "[comment `foo]",
     "[link http://www.huiketong.com/]",
     "[comment `foo]",
     "",
     "[link http://www.huiketong.com/]");
  ...
  MT("headerCodeBlockGithub",
     ...
     "Issue: [link #1]",
     "Link: [link http://www.huiketong.com/]");
