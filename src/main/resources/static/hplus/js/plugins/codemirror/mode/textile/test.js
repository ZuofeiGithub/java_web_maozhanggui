...
(function() {
  ...
  MT('image',
      'An image: [string !http://www.huiketong.com/image.png!]');

  MT('imageWithAltText',
      'An image: [string !http://www.huiketong.com/image.png (Alt Text)!]');

  MT('imageWithUrl',
      'An image: [string !http://www.huiketong.com/image.png!:http://www.huiketong.com/]');
  ...
  MT('html',
      ...
      '[variable-2 * Item two]',
      '',
      '[comment <a href="http://huiketong.com">Example</a>]',
      '',
      '[comment </section>]',
      '[comment </div>]');
