...
(function() {
  ...
  FT("formatting_link",
     "[link&formatting&formatting-link [][link foo][link&formatting&formatting-link ]]][string&formatting&formatting-link-string (][string http://huiketong.com/][string&formatting&formatting-link-string )]");
  ...
  FT("formatting_linkReference",
     ...
     "[link&formatting&formatting-link [][link bar][link&formatting&formatting-link ]]:] [string http://huiketong.com/]");

  FT("formatting_linkWeb",
     "[link&formatting&formatting-link <][link http://huiketong.com/][link&formatting&formatting-link >]");

  FT("formatting_linkEmail",
     "[link&formatting&formatting-link <][link user@huiketong.com][link&formatting&formatting-link >]");
  ...
  MT("linkTitle",
     "[link [[foo]]][string (http://huiketong.com/ \"bar\")] hello");

  // Inline link without title
  MT("linkNoTitle",
     "[link [[foo]]][string (http://huiketong.com/)] bar");

  // Inline link with image
  MT("linkImage",
     "[link [[][tag ![[foo]]][string (http://huiketong.com/)][link ]]][string (http://huiketong.com/)] bar");

  // Inline link with Em
  MT("linkEm",
     "[link [[][link&em *foo*][link ]]][string (http://huiketong.com/)] bar");

  // Inline link with Strong
  MT("linkStrong",
     "[link [[][link&strong **foo**][link ]]][string (http://huiketong.com/)] bar");

  // Inline link with EmStrong
  MT("linkEmStrong",
     "[link [[][link&strong **][link&em&strong *foo**][link&em *][link ]]][string (http://huiketong.com/)] bar");

  // Image with title
  MT("imageTitle",
     "[tag ![[foo]]][string (http://huiketong.com/ \"bar\")] hello");

  // Image without title
  MT("imageNoTitle",
     "[tag ![[foo]]][string (http://huiketong.com/)] bar");
  ...
  MT("labelNoTitle",
     "[link [[foo]]:] [string http://huiketong.com/]");

  MT("labelIndented",
     "   [link [[foo]]:] [string http://huiketong.com/]");

  MT("labelSpaceTitle",
     "[link [[foo bar]]:] [string http://huiketong.com/ \"hello\"]");

  MT("labelDoubleTitle",
     "[link [[foo bar]]:] [string http://huiketong.com/ \"hello\"] \"world\"");
  ...
  MT("linkWeb",
     "[link <http://huiketong.com/>] foo");

  MT("linkWebDouble",
     "[link <http://huiketong.com/>] foo [link <http://huiketong.com/>]");

  MT("linkEmail",
     "[link <user@huiketong.com>] foo");

  MT("linkEmailDouble",
     "[link <user@huiketong.com>] foo [link <user@huiketong.com>]");
