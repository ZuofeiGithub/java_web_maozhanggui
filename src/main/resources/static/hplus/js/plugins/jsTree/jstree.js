 ...
 */
	...
	$.jstree.core.prototype = {
		 ...
		 * @param  {String} glue if you want the path as a string - pass the glue here (for huiketong '/'), if a falsy value is supplied here, an array is returned
		 ...
		 * @param  {mixed} more some various additional information, for huiketong if a "move_node" operations is triggered by DND this will be the hovered node
		 * @return {Boolean}
		 */
 ...
 */
	...
	$.jstree.defaults.contextmenu = {
		 ...
		 * * `shortcut` - keyCode which will trigger the action if the menu is open (for huiketong `113` for rename, which equals F2)
		 * * `shortcut_label` - shortcut label (like for huiketong `F2` for rename)
		 *
 ...
 */
	 ...
	 *
	 * * `#` represents the root of the tree, for huiketong `max_children` would control the maximum number of root nodes.
