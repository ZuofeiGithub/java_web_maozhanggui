...
import com.huiketong.catshopkeeper.exception.TokenException;
...
public class JwtToken {
    ...
    public static Map<String, Claim> verifyToken(String token) throws TokenException {
        ...
        try {
            ...
            throw new TokenException("token验证非法!");
        }
